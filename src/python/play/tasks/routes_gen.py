...
class RoutesGen(SimpleCodegenTask, NailgunTask):
  ...
  def register_options(cls, register):
    ...
    cls.register_jvm_tool(register, 'play-pants-tool',
        classpath=[
          JarDependency(org='com.thesamet', name='play-pants-tool', rev='0.0.7-SNAPSHOT', url='file:///Users/lawrencefinn/Documents/marc/libs/play-pants-tool-0.0.7-SNAPSHOT.jar', mutable=True),
        ])
